...
import "./PrimarySurveyBasicDetails.scss"


const PrimarySurveyBasicDetails = (props: any) => {
    ...
    const onPrimaryChangeHandler = (e: any) => {
        setIsPrimary(!isPrimary)
        props.onPrimaryChangeHandler(!isPrimary)
    }
    ...
    return <>
        <Container>
            <div className="primary-survey-basic-details mt-3 mb-4">
                <h3>Basic Details</h3>
                    ...
                    <Row>
                        ...
                        <Col sm={6} md={4}>
                            <Form.Group className="mb-3" controlId="formBasicNoOfSurveys">
                                <Form.Label>No. Of Surveys Required</Form.Label>
                        ...
                        <Col sm={6} md={4}>
                            <Form.Group className="mb-3" controlId="formBasicDuration">
                                <Form.Label>Primary Survey</Form.Label>
                                <Form.Check // prettier-ignore
                                    type={"checkbox"}
                                    id={`is_primary-checkbox`}
                                    label={`Yes`}
                                    checked={isPrimary}
                                    onChange={(e) => onPrimaryChangeHandler(e)}
                                />
                            </Form.Group>
                        </Col>
                        <Col sm={6} md={4}>
...
export default PrimarySurveyBasicDetails